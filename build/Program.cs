    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Orchestrator
                ...
                .Then(Test)
                .Then(GenerateSBOMManifestForZips, skip: !args.Contains("--addSBOM"))
                .Then(Zip)
                .Then(DotnetPublishForNupkg)
                .Then(GenerateSBOMManifestForNupkg, skip: !args.Contains("--addSBOM"))
                .Then(DotnetPack)
                .Then(DeleteSBOMTelemetryFolder, skip: !args.Contains("--addSBOM"))
