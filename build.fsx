...
Target "AddPythonWorker" (fun _ ->
    use webClient = new WebClient ()
    [
        (Uri("https://raw.githubusercontent.com/Azure/azure-functions-python-worker/1.0.224-alpha/python/worker.py"), toolsDir @@ "worker.py")
        (Uri("https://raw.githubusercontent.com/Azure/azure-functions-python-worker/1.0.224-alpha/python/worker.config.json"), toolsDir @@ "worker.config.json")
    ]
