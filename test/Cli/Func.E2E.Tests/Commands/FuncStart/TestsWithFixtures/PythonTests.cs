...
{
    [Collection("Python")]
    public class PythonTests : IClassFixture<PythonFunctionAppFixture>
    {
        private readonly PythonFunctionAppFixture _fixture;

        public PythonTests(PythonFunctionAppFixture fixture, ITestOutputHelper log)
        {
            _fixture = fixture;
            _fixture.Log = log;
        }
        ...
        [Fact]
        public void Start_PythonApp_SuccessfulFunctionExecution()
        {
            int port = ProcessHelper.GetAvailablePort();

            // Call func start
            var funcStartCommand = new FuncStartCommand(_fixture.FuncPath, nameof(Start_PythonApp_SuccessfulFunctionExecution), _fixture.Log);
            ...
            var result = funcStartCommand
                        ...
                        .WithEnvironmentVariable("FUNCTIONS_WORKER_RUNTIME", "python")
