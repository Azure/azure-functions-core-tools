...
{
    [Collection("Java")]
    public class JavaTests : IClassFixture<JavaFunctionAppFixture>
    {
        private readonly JavaFunctionAppFixture _fixture;

        public JavaTests(JavaFunctionAppFixture fixture, ITestOutputHelper log)
        {
            _fixture = fixture;
            _fixture.Log = log;
        }
        ...
        [Fact]
        public void Start_JavaApp_SuccessfulFunctionExecution()
        {
            int port = ProcessHelper.GetAvailablePort();

            // Call func start
            var funcStartCommand = new FuncStartCommand(_fixture.FuncPath, nameof(Start_JavaApp_SuccessfulFunctionExecution), _fixture.Log);
            ...
            var result = funcStartCommand
                        ...
                        .WithEnvironmentVariable("FUNCTIONS_WORKER_RUNTIME", "java")
