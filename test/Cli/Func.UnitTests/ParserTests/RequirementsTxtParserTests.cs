...
namespace Azure.Functions.Cli.UnitTests.ParserTests
{
    public class RequirementsTxtParserTests
    {
        ...
        {
            List<PythonPackage> result = RequirementsTxtParser.ParseRequirementsTxtContent(string.Empty);
            Assert.Empty(result);
        }
        ...
        {
            List<PythonPackage> result = RequirementsTxtParser.ParseRequirementsTxtContent("# This is a comment");
            Assert.Empty(result);
        }
        ...
        {
            List<PythonPackage> result = RequirementsTxtParser.ParseRequirementsTxtContent("--extra-index = https://extra.index.org");
            Assert.Empty(result);
        }
        ...
        {
            List<PythonPackage> result = RequirementsTxtParser.ParseRequirementsTxtContent("numpy<>3.5.2");
            Assert.Empty(result);
        }
        ...
        {
            List<PythonPackage> result = RequirementsTxtParser.ParseRequirementsTxtContent("numpy");
        ...
        {
            List<PythonPackage> result = RequirementsTxtParser.ParseRequirementsTxtContent(content);
            Assert.Single(result);
        ...
        {
            List<PythonPackage> result = RequirementsTxtParser.ParseRequirementsTxtContent("numpy; python_version == '2.7'");
            Assert.Single(result);
        ...
        {
            List<PythonPackage> result = RequirementsTxtParser.ParseRequirementsTxtContent("numpy>=3.5.1; python_version == '2.7'");
            Assert.Single(result);
        ...
        {
            List<PythonPackage> result = RequirementsTxtParser.ParseRequirementsTxtContent("numpy @ https://direct.reference/numpy");
            Assert.Single(result);
        ...
        {
            List<PythonPackage> result = RequirementsTxtParser.ParseRequirementsTxtContent("numpy==3.5.2 @ https://direct.reference/numpy");
            Assert.Single(result);
