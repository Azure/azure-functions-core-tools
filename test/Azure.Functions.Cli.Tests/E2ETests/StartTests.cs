...
namespace Azure.Functions.Cli.Tests.E2ETests
{
    ...
    [Trait(TestTraits.Group, TestTraits.FuncStartTests)]
            ...
            await CliTester.Run(new RunConfiguration[]
            {
                ...
                new RunConfiguration
                {
                    ...
                    Test = async (_, p, stdout) =>
                    {
                        ...
                        await LogWatcher.WaitForLogOutput(stdout, "C# Queue trigger function processed: hello world", TimeSpan.FromSeconds(5));
