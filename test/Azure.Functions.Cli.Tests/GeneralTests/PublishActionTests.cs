...
namespace Azure.Functions.Cli.Tests.GeneralTests
{
    ...
    public class PublishActionTests
    {
        ...
        public async Task NetFrameworkVersion_DotnetIsolated_Linux_Consumption_Updated(string initialLinuxFxVersion, string expectedNetFrameworkVersion)
        {
            ...
            await UpdateFrameworkVersions(site, WorkerRuntime.dotnetIsolated, expectedNetFrameworkVersion, false, _helperService);
        ...
        public async Task NetFrameworkVersion_DotnetIsolated_Linux_Dedicated(string specifiedVersion)
        {
            ...
            await UpdateFrameworkVersions(site, WorkerRuntime.dotnetIsolated, specifiedVersion, false, _helperService);
        ...
        public async Task NetFrameworkVersion_DotnetIsolated_Linux_Null()
        {
            ...
            await UpdateFrameworkVersions(site, WorkerRuntime.dotnetIsolated, null, false, _helperService);
        ...
        public async Task NetFrameworkVersion_Dotnet_Windows_Null()
        {
            ...
            await UpdateFrameworkVersions(site, WorkerRuntime.dotnet, null, false, _helperService);
        ...
        public async Task NetFrameworkVersion_Invalid(string specifiedVersion)
        {
            ...
            var exception = await Assert.ThrowsAsync<CliException>(() =>
                UpdateFrameworkVersions(site, WorkerRuntime.dotnetIsolated, specifiedVersion, false, _helperService));
