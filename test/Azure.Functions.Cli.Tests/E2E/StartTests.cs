...
namespace Azure.Functions.Cli.Tests.E2E
{
    public class StartTests : BaseE2ETest
    {
        ...
        [Fact]
        public async Task Start_MissingLocalSettingsJson_WorkerRuntime_None()
        {
            await CliTester.Run(new RunConfiguration[]
            {
                new RunConfiguration
                ...
                new RunConfiguration
                {
                    ...
                    Commands = new[]
                    {
                        $"start --worker-runtime None --port 7073",
                    },
                    ExpectExit = false,
                    OutputContains = new[]
                    {
        ...
        [Fact]
        public async Task Start_MissingLocalSettingsJson_WorkerRuntime_NotProvided()
        {
            await CliTester.Run(new RunConfiguration[]
            {
                new RunConfiguration
