...
namespace Azure.Functions.Cli.Common
{
    internal static partial class Constants
    {
        ...
        public static class Errors
        {
            ...
            public const string PublishNetworkingError = "Unable to connect to the Azure Function App. If public network access is disabled for this app, ensure you are deploying from an authorized network. For more information, see https://aka.ms/func-network-deployment-errors";
