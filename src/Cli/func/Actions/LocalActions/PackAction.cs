...
namespace Azure.Functions.Cli.Actions.LocalActions
{
    ...
    internal class PackAction : BaseAction
    {
        ...
        public override async Task RunAsync()
        {
            ...
            var stream = await ZipHelper.GetAppZipFile(functionAppRoot, BuildNativeDeps, BuildOption.Default, noBuild: false, ignoreParser: null, AdditionalPackages, ignoreDotNetCheck: true);
