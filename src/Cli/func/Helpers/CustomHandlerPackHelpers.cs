...
namespace Azure.Functions.Cli.Helpers
{
    ...
    public static class CustomHandlerPackHelpers
    {
        ...
        public static async Task<Stream> CreateCustomHandlerZipAsync(string functionAppRoot, GitIgnoreParser ignoreParser = null)
        {
            ...
            return CreateZipWithExecutables(files, functionAppRoot, executables);
        }

        /// <summary>
        /// Creates a zip stream with proper executable permissions set for specified files
        /// </summary>
        /// <param name="files">Files to include in the zip</param>
        /// <param name="rootPath">Root path for the files</param>
        /// <param name="executables">Files that should have executable permissions</param>
        /// <returns>Stream containing the zip file with proper permissions</returns>
        public static Stream CreateZipWithExecutables(IEnumerable<string> files, string rootPath, IEnumerable<string> executables)
        {
            ...
            if (useGoZip)
            {
                if (GoZipExists(out string goZipLocation))
                {
                    ...
                    return CreateGoZipWithExecutables(files, rootPath, zipFilePath, goZipLocation, executables).GetAwaiter().GetResult();
                }
            ...
            return CreateDotNetZipWithExecutables(files, rootPath, executables);
        }

        /// <summary>
        /// Creates a DotNet zip with executable permissions set for specified files
        /// </summary>
        /// <param name="files">Files to include in the zip</param>
        /// <param name="rootPath">Root path for the files</param>
        /// <param name="executables">Files that should have executable permissions</param>
        /// <returns>Stream containing the zip file with proper permissions</returns>
        public static Stream CreateDotNetZipWithExecutables(IEnumerable<string> files, string rootPath, IEnumerable<string> executables)
        {
        ...
        /// <summary>
        /// Creates a GoZip with executable permissions set for specified files
        /// </summary>
        /// <param name="files">Files to include in the zip</param>
        /// <param name="rootPath">Root path for the files</param>
        /// <param name="zipFilePath">Path where the zip file should be created</param>
        /// <param name="goZipLocation">Location of the gozip executable</param>
        /// <param name="executables">Files that should have executable permissions</param>
        /// <returns>Stream containing the zip file with proper permissions</returns>
        public static async Task<Stream> CreateGoZipWithExecutables(IEnumerable<string> files, string rootPath, string zipFilePath, string goZipLocation, IEnumerable<string> executables)
        {
        ...
        /// <summary>
        /// Checks if GoZip executable exists
        /// </summary>
        /// <param name="fileLocation">Output parameter containing the location of gozip if found</param>
        /// <returns>True if gozip exists, false otherwise</returns>
