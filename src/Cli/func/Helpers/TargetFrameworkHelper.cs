...
namespace Azure.Functions.Cli.Helpers
{
    public static class TargetFrameworkHelper
    {
        ...
        private static readonly IEnumerable<string> _supportedTargetFrameworks = [TargetFramework.Net11, TargetFramework.Net10, TargetFramework.Net9, TargetFramework.Net8, TargetFramework.Net7, TargetFramework.Net6, TargetFramework.Net48];
