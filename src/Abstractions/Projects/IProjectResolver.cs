...
public interface IProjectResolver
{
    ...
    /// <summary>
    /// Retrieves the runtime stack information for the project.
    /// </summary>
    /// <param name="workingDirectory">The working directory of the project.</param>
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <returns>A task that represents the asynchronous operation. The task result contains the runtime stack information.</returns>
