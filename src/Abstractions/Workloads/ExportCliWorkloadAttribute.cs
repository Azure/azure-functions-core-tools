...
/// add a single <c>[assembly: ExportCliWorkload&lt;MyWorkload&gt;]</c>
...
/// type — surfaces the requirement at the call site rather than at install
/// time.
/// </typeparam>
/// <remarks>
/// <para>
...
public sealed class ExportCliWorkloadAttribute<T> : Attribute
    where T : IWorkload;
