...
/// Read-only view over installed bundle workload rows in the global workload registry.

/// </summary>
public interface IInstalledBundleWorkloads
{
    /// <summary>
    /// NuGet package id of the bundles workload. Matched case-insensitively.
    /// </summary>
...
/// One installed bundle workload row. <see cref="InstallDirectory"/> is the workload's extracted install dir.
