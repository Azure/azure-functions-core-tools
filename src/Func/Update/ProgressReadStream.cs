...
/// <summary>
/// Read-only stream wrapper that reports cumulative bytes read.
/// </summary>
internal sealed class ProgressReadStream(Stream inner, long? totalBytes, IProgress<UpdateProgress> progress) : Stream
{
