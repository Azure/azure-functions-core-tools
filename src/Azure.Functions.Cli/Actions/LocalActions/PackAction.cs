...
namespace Azure.Functions.Cli.Actions.LocalActions
{
    ...
    internal class PackAction : BaseAction
    {
        ...
        public override async Task RunAsync()
        {
            ...
            var stream = await ZipHelper.GetAppZipFile(workerRuntime, functionAppRoot, BuildNativeDeps, noBuild: false, buildOption: BuildOption.None, additionalPackages: AdditionalPackages);
