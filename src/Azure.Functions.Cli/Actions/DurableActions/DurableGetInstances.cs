    ...
    class DurableGetInstances : BaseDurableAction
    {
        ...
        public override ICommandLineParserResult ParseArgs(string[] args)
        {
            Parser
                ...
                .WithDescription("(Optional) Retrieve the instances created after this date/time (UTC). Format: mm/dd/yyyy HH:mm")
                .SetDefault(DateTime.MinValue)
                .Callback(n => CreatedTimeFrom = n);
            Parser
                .Setup<DateTime>("created-before")
                .WithDescription("(Optional) Retrieve the instances created before this date/time (UTC). Format: mm/dd/yyyy HH:mm")
