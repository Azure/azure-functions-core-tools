![Azure Functions Logo](https://raw.githubusercontent.com/Azure/azure-webjobs-sdk-script/rename-cli/src/Azure.Functions.Cli/npm/assets/azure-functions-logo-color-raster.png)
