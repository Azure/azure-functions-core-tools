...
/// <summary>
/// File-write and <c>host.json</c>-merge helpers for the Python workload.
/// </summary>
internal static class ProjectFiles
{
    ...
    /// <summary>
    /// Reads an embedded template by relative path. Throws when the resource is missing so build-time mistakes surface loudly.
    /// </summary>
