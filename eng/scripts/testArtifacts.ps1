# This script calls the consolidated implementation in ArtifactAssemblerHelpers/testArtifacts.ps1
...
& (Join-Path $PSScriptRoot "ArtifactAssemblerHelpers\testArtifacts.ps1") -StagingDirectory $StagingDirectory