...
$ToolsRuntimeToPowershellRuntimes = @{
  "7"   = @{
    "win-x86"   = @("win", "win-x86", "win10-x86", "win-x64", "win10-x64")
    "win-x64"   = @("win", "win-x86", "win10-x86", "win-x64", "win10-x64")
    "win-arm64" = @("win", "win-arm", "win-arm64")
    "linux-x64" = @("unix", "linux", "linux-x64", "linux-musl-x64")
    "osx-x64"   = @("unix", "osx", "osx-x64")
    "osx-arm64" = @("osx", "unix")
  }
  "7.2" = @{
    "win-x86"   = @("win", "win-x86", "win10-x86", "win-x64", "win10-x64")
